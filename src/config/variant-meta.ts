...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Refuge Studios Pty Ltd. Directors Hub',
    description: 'Refuge Studios Pty Ltd’s internal Directors Hub — real-time global intelligence dashboard tracking conflicts, markets, military activity, and OSINT signals across 190+ countries, with live context in one view. Forked from the open-source World Monitor project (github.com/koala73/worldmonitor).',
    ...
    url: 'https://director.srv996920.hstgr.cloud/',
    siteName: 'Refuge Studios Pty Ltd. Directors Hub',
    shortName: 'Directors Hub',
